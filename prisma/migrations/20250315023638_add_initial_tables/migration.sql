-- CreateEnum
CREATE TYPE "UserType" AS ENUM ('SALESPERSON', 'MANAGER');

-- CreateEnum
CREATE TYPE "SalesStatus" AS ENUM ('PENDING', 'FINISHED', 'APPROVED', 'REJECTED');
...
-- AddForeignKey
ALTER TABLE "Request" ADD CONSTRAINT "Request_saleId_fkey" FOREIGN KEY ("saleId") REFERENCES "Sale"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
